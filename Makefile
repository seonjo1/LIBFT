...
OBJS = $(SRCS:.c=.o)
SRCS1 = ft_lstmap.c ft_lstiter.c ft_lstclear.c ft_lstdelone.c ft_lstadd_back.c ft_lstlast.c ft_lstnew.c ft_lstadd_front.c ft_lstsize.c
SRCS2 = $(SRCS1:.c=:_bonus.c)
OBJS2 = $(SRCS2:.c=.o)
